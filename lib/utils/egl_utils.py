...
try:
    _eglQueryDevicesEXT = PFNEGLQUERYDEVICESEXTPROC(egl.eglGetProcAddress('eglQueryDevicesEXT'))
...
try:
    eglQueryDeviceAttribEXT = PFNEGLQUERYDEVICESATTRIBEXTPROC(egl.eglGetProcAddress('eglQueryDeviceAttribEXT'))
except TypeError as e:
